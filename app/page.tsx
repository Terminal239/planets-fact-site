    ...
    <section className="introduction">
      <MaxWidthWrapper>
        ...
        <div className="planets">
          ...
          <div className="item">
            <h3>Earth: Our Oasis in Space</h3>
            <p>
          ...
          <div className="item">
            <h3>Jupiter: The Giant of the Solar System</h3>
            <p>
          ...
          <div className="item">
            <h3>Saturn: The Ringed Wonder</h3>
            <p>
          ...
          <div className="item">
            <h3>Neptune: The Mystic Blue Giant</h3>
            <p>
